...
/**
 * Created by haoyaun on 2018/1/31.
 */

public abstract class BaseLoadingFragment extends BaseTopbarFragment implements ILoadingView {
    ...
    private void initQmuiDialogBuilder() {
        if (tipDialogBuilder == null) {
            tipDialogBuilder = new QMUITipDialog.Builder(getActivity());
        }
        if (rxTimer == null) {
            rxTimer = new RxTimer();
        }
